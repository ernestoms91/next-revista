...
export const MyDateInput = ( { label, classNameLabel ,classNameInput,  ...props }: Props ) => {

    const [ field ] = useField(props)
    const date = new Date;
    let dateToString = date.toLocaleString("fr-CA").split(' ')
    ...
    return (
        <>
            ...
            <Field  className={`text-input ${classNameInput} `} min= {dateToString[0]} { ...field } { ...props } id={props.name} />
