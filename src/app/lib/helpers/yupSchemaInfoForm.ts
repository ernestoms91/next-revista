...
export const interviewSchema = () => {
  return Yup.object().shape({
    ...
    entrevistado: Yup.string()
      .required("El nombre del entrevistado es obligatorio")
      .min(2, "El nombre del entrevistado  es muy corto"),

    entrevistador: Yup.string()
      .required("El nombre del entrevistador es obligatorio")
      .min(2, "El nombre del entrevistador  es muy corto"),
