        ...
        <Formik
          ...
          onSubmit={async (values, actions) => {
            try {
             ...
             setError(false)
              const { data } = await revistaApi.post(`interviews`, {
                title: values.titulo,
                ...
                interviewer: values.entrevistado,
                interviewee: values.entrevistador,
          ...
          {({
            ...
            >
              ...
              <MyTextInput
                ...
                classNameInput={`bg-gris-claro block p-4  rounded-l-full rounded-t-full w-full border-2 ${
                  errors.entrevistado && touched.entrevistado ? "border-rose-600" : ""
                }`}
              ...
              <MyTextInput
                ...
                classNameInput={`bg-gris-claro block p-4  rounded-l-full rounded-t-full w-full border-2 ${
                  errors.entrevistador && touched.entrevistador ? "border-rose-600" : ""
                }`}
